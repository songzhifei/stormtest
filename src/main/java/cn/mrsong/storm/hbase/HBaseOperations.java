...
public class HBaseOperations implements Serializable {
	...
	public void createTable(String tableName, List<String> ColumnFamilies) {
		...
		try {
			...
			/*
			 * execute the creaetTable(HTableDescriptor tableDescriptor) of
			 * HBaseAdmin class to createTable into HBase.
			 */
	...
	public static void main(String[] args) {
		...
		record.put("cf1", cf1);
		record.put("cf2", cf2);
		HBaseOperations hbaseOperations = new HBaseOperations("test3", cFs, zks, 2181);
